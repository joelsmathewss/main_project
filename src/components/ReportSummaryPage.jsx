...
export default function ReportSummaryPage() {
  ...
  const handleGenerate = () => {
    ...
    setTimeout(() => {
      setSummary(
        language === "ml"
          ? "ഇത് നിങ്ങളുടെ മെഡിക്കൽ റിപ്പോർട്ടിന്റെ ലളിതമായ വിശദീകരണമാണ്...\n\n(This is a sample summary in Malayalam.)"
          : "Based on the analysis of your medical report, here is the simplified summary:\n\n• Bone Density: Normal for your age group.\n• Blood Pressure: Slightly elevated (130/85).\n• Recommendation: Continue with your current diet.\n\n(This is an AI-generated explanation.)"
      );
      setLoading(false);
    }, 2000);
  };
                ...
                {!loading && !summary && (
                  <div className="h-full flex flex-col items-center justify-center p-10 text-center">
                    ...
                    <p className="max-w-xs mx-auto text-sm text-gray-500 leading-relaxed">
                      Please upload a medical document on the left panel to
